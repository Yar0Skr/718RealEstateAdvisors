...
/**
 * EstatesController implements the CRUD actions for Estates model.
 */
class EstatesController extends ParentController
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (($model = Estates::findOne($id)) !== null) {
            return $model;
        }
